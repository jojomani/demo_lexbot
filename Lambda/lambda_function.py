...
def recommend_portfolio(intent_request):
    ...
    if age >= 25 and age <=65:
        ...
        output = "Please re-enter your age between 25 and 65 and a minimum of $5000 investment."
    return output
    ...
    if age is not None:
        ...
        if age not in range (25,65):      
            return build_validation_result(
                False,
                "age",
                "You should be at least 25yo to open an account with us. Please re-enter an age between 25 to 65 years old.",
            )
